    ...
    return (
        <div className="flex flex-col p-6 bg-gray-800 outline outline-2 outline-white rounded-xl shadow-md">
            ...
            <div className="relative">
                <div className="max-h-96 overflow-y-auto"> {/* Define o scroll vertical */}
                    <table className="min-w-full table-auto border-collapse">
                        <thead className="bg-orange-500 rounded-xl shadow-md">
                            <tr>
                                <th className="px-2 py-3 text-left text-white text-base lg:text-xl font-medium sm:text-sm min-w-[100px] sticky top-0 z-10 bg-orange-500"> {/* Adicione `sticky top-0` para manter fixo */}
                                    ESTAÇÃO
                                </th>
                                <th className="px-2 py-3 text-left text-white text-base lg:text-xl font-medium sm:text-sm min-w-[100px] sticky top-0 z-10 bg-orange-500">
                                    ROTA
                                </th>
                                <th className="px-2 py-3 text-left text-white text-base lg:text-xl font-medium sm:text-sm min-w-[100px] sticky top-0 z-10 bg-orange-500">
                                    HORÁRIO
